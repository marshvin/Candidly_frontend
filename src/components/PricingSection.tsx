    ...
    <section className="py-16 bg-gray-50">
      <div className="skillforge-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Starter Plan */}
          <Card className="border-2 border-gray-200 hover:border-skillforge-300 transition-all duration-300">
            <CardHeader>
              <div className="flex justify-between items-start">
                ...
                <CreditCard className="h-8 w-8 text-skillforge-500" />
              </div>
              <div className="mt-4">
            ...
            <CardContent>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-skillforge-500 mr-2 mt-0.5 flex-shrink-0" />
          ...
          {/* Pro Plan */}
          <Card className="border-2 border-skillforge-400 bg-white shadow-lg transform md:-translate-y-4 relative">
            <div className="absolute -top-3 left-0 right-0 flex justify-center">
              <Badge className="bg-skillforge-600 text-white">MOST POPULAR</Badge>
            </div>
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
            ...
            <CardContent>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-skillforge-600 mr-2 mt-0.5 flex-shrink-0" />
            ...
            <CardFooter>
              <Button className="w-full bg-skillforge-600 hover:bg-skillforge-700" asChild>
          ...
          <Card className="border-2 border-gray-200 hover:border-skillforge-300 transition-all duration-300">
            <CardHeader>
              <div className="flex justify-between items-start">
                ...
                <Shield className="h-8 w-8 text-skillforge-500" />
              </div>
              <div className="mt-4">
        ...
        <div className="mt-12 text-center">
          ...
          <Button variant="link" className="text-skillforge-600" asChild>
